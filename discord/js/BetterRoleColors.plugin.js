...
module.exports = (() => {
    const config = {info:{name:"BetterRoleColors",
			  authors:[{name:"Zerebos",
		    ...
		    changelog:[{title:"Bug Fixes",
				type:"fixed",
				items:["Fixed account details not being colored.",
				       "Fixed not coloring user modals.",
				       "Fixed an issue where account details might stay colored after disabling plugin."]}],
		    defaultConfig:[{type:"category",
				    id:"global",
				    name:"전역 설정",
				    collapsible:true,
				    shown:false,
				    settings:[
						{type:"switch",
							id:"important",
							name:"중요한 사용",
							note:"역할 색상에 !important를 추가하세요. (플러그인이 테마에서 작동하지 않는 경우에만 활성화하세요).",
							value:false}]},
						{type:"category",
							id:"modules",
							name:"모듈 설정",
						...
						{type:"switch",
							id:"typing",
							name:"Typing",
							note:"입력 알림의 색상 지정을 토글합니다.",
							value:true},
						{type:"switch",
							id:"voice",
							name:"Voice",
							note:"음성 사용자의 색상 지정을 토글합니다.",
							value:true},
						{type:"switch",
							id:"mentions",
							name:"Mentions",
							note:"채팅에서 사용자 멘션의 색상 지정을 토글합니다.",
							value:true},
						{type:"switch",
							id:"botTags",
							name:"Bot Tags",
							note:"역할에 맞게 봇 태그의 배경 색상을 전환합니다.",
							value:true},
						{type:"switch",
							id:"memberList",
							name:"Memberlist Headers",
							note:"구성원 목록에서 역할 이름 색칠을 토글합니다.",
							value:true}]},
						{type:"category",
							id:"popouts",
							name:"팝아웃 옵션",
						...
						{type:"switch",
							id:"username",
							name:"Username",
							note:"팝아웃에서 사용자 이름의 색상 지정을 토글합니다.",
							value:false},
						{type:"switch",
							id:"discriminator",
							name:"Discriminator",
							note:"팝아웃의 판별자에 대한 색상 지정을 토글합니다.",
							value:false},
						{type:"switch",
							id:"nickname",
							name:"Nickname",
							note:"팝아웃에서 닉네임의 색상을 전환합니다.",
							value:true},
						{type:"switch",
							id:"fallback",
							name:"Enable Fallback",
							note:"닉네임이 켜져 있고 사용자 이름이 꺼져 있는 경우 활성화하면 자동으로 사용자 이름에 색상이 지정됩니다.",
							value:true}]},
						{type:"category",
							id:"modals",
							name:"모달 옵션",
					...
					settings:[
						{type:"switch",
							id:"username",
							name:"Username",
							note:"모달에서 사용자 이름의 색상 지정을 토글합니다.",
							value:true},
						{type:"switch",
							id:"discriminator",
							name:"Discriminator",
							note:"모달의 판별자에 대한 색상 지정을 토글합니다.",
							value:false}]},
						{type:"category",
							id:"auditLog",
							name:"감사 로그 옵션",
					...
					settings:[{type:"switch",
							id:"username",
							name:"Username",
							note:"감사 로그의 사용자 이름에 대한 색상 지정을 토글합니다.",
							value:true},
						{type:"switch",
							id:"discriminator",
							name:"Discriminator",
							note:"감사 로그의 판별자에 대한 색상 지정을 토글합니다.",
							value:false}]},
						{type:"category",
							id:"account",
							name:"계정 세부 정보 옵션",
					...
					settings:[
						{type:"switch",
							id:"username",
							name:"Username",
							note:"계정 세부정보에서 사용자 이름의 색상을 전환합니다.",
							value:true},
						{type:"switch",
							id:"discriminator",
							name:"Discriminator",
							note:"계정 세부 정보의 판별자에 대한 색상 지정을 토글합니다.",
							value:false}]},
						{type:"category",
							id:"mentions",
							name:"멘션 옵션",
					...
					settings:[
						{type:"switch",
							id:"changeOnHover",
							name:"Hover Color",
							note:"이 기능을 켜면 역할 색상과 일치하도록 마우스를 가져갈 때 색상이 조정되고 테마에 따라 해제됩니다.",
							value:true}]}],
				main:"index.js"};
